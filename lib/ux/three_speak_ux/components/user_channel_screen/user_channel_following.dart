...
import 'package:hive_flutter_kit/core/three_speak_core/models/user_profile/request/user_followers_request.dart';
import 'package:hive_flutter_kit/core/three_speak_core/models/user_profile/response/followers_and_following.dart';
import 'package:hive_flutter_kit/ux/three_speak_ux/components/user_channel_screen/follower_list_tile.dart';
...
class _UserChannelFollowingWidgetState extends State<UserChannelFollowingWidget>
  ...
  Widget _futureFollowers() {
    return FutureBuilder(
      future: _loadFollowers(widget.owner, "api.hive.blog"),
