        ...
        builder: (context, constraints) {
          return GridView.builder(
            ...
            gridDelegate: SliverGridDelegateWithMaxCrossAxisExtent(
              maxCrossAxisExtent: 350, // Each card max 350px wide
              mainAxisSpacing: 16,
              crossAxisSpacing: 16,
              childAspectRatio: 0.85, // Lower for more height per card
            ),
            padding: const EdgeInsets.symmetric(
              horizontal: 16,
              vertical: 8, // Reduce vertical padding to minimize top space
            ),
            itemCount:
              ...
              children: [
                ...
                LayoutBuilder(
                  builder: (context, constraints) {
                    ...
                    return Padding(
                      padding: EdgeInsets.only(left: isMobile ? 0 : 120),
                      child: Wrap(
                        spacing: 16,
                        runSpacing: 8,
                        alignment:
