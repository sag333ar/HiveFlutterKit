...
class GQLFeedItem {
  ...
  factory GQLFeedItem.fromJson(Map<String, dynamic> json) => GQLFeedItem(
    ...
    isVideo:
        json['json_metadata']?['raw']?['video']?['info']?['video_v2']?.endsWith(
          '.m3u8',
        ) ??
        true,
    stats:
        json["stats"] == null ? null : GQLFeedItemStats.fromJson(json["stats"]),
    spkvideo:
        json["spkvideo"] == null ? null : Spkvideo.fromJson(json["spkvideo"]),
  ...
  String get hlsUrl {
    if ((spkvideo?.playUrl ?? '').contains('ipfs')) {
      ...
      // https://ipfs-3speak.b-cdn.net/ipfs/QmTRDJcgtt66pxs3ZnQCdRw57b69NS2TQvF4yHwaux5grT/480p/index.m3u8
      // https://ipfs-3speak.b-cdn.net/ipfs/QmWADpD1PWPnmYVkSZvgokU5vcN2qZqvsHCA985GZ5Jf4r/manifest.m3u8
      var url = (spkvideo?.playUrl ?? '').replaceAll(
        'ipfs://',
...
class GQLFeedItemAuthor {
  ...
  GQLFeedItemAuthor({this.username});
  ...
  factory GQLFeedItemAuthor.fromJson(Map<String, dynamic> json) =>
      GQLFeedItemAuthor(username: json["username"]);
...
class CommunityImages {
  ...
  CommunityImages({this.avatar, this.cover});
  ...
  factory CommunityImages.fromJson(Map<String, dynamic> json) =>
      CommunityImages(avatar: json["avatar"], cover: json["cover"]);

  Map<String, dynamic> toJson() => {"avatar": avatar, "cover": cover};
}
...
class GQLFeedItemStats {
  ...
  GQLFeedItemStats({this.totalHiveReward, this.numVotes, this.numComments});
...
class VideoDetailsFeed {
  ...
  factory VideoDetailsFeed.fromJson(Map<String, dynamic> json) =>
      VideoDetailsFeed(item: GQLFeedItem.fromJson(json['data']['socialPost']));
