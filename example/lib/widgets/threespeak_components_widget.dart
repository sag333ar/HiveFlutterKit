...
typedef ShowVideoOptionsCallback =
    void Function(BuildContext context, String videoId);
...
class ThreeSpeakComponentsWidget extends StatelessWidget {
  ...
  final VoidCallback
  onUserLogout; // Callback for when user logs out from ThreeSpeakCurrentUserAccount
              ...
              MaterialPageRoute(
                builder:
                    (context) => VideoUploadScreen(
                      owner:
                          'shaktimaaan', // TODO: Parameterize or get from logged-in state
              ...
              MaterialPageRoute(
                builder:
                    (context) => ThreeSpeakCurrentUserAccount(
                      ...
                      onTabChanged:
                          (tabIndex) =>
                              showSnackBar('Tab changed to: $tabIndex'),
                      onLogout: () {
                      ...
                      onPublish:
                          (username, permlink) => showSnackBar(
                      ...
                      onMoreOptions:
                          (videoId) => showVideoOptionsSheet(context, videoId),
                    ),
              ),
            );
          },
              ...
              MaterialPageRoute(
                builder:
                    (context) => ThreeSpeakVideoFeed(
                      ...
                      onTapComment:
                          (item) =>
                              showSnackBar('Tapped comment: ${item.permlink}'),
                    ),
              ),
            );
          },
                          ...
                          MaterialPageRoute(
                            builder:
                                (context) => ThreeSpeakVideoFeed(
                                  ...
                                  onTapAuthor:
                                      (item) => showSnackBar(
                                        'Tapped author: ${item.author}',
                                      ),
                                  onTapReport:
                                      (item) => showSnackBar(
                                        'Tapped report: ${item.permlink}',
                                      ),
                                  onTapUpvote:
                                      (item) => showSnackBar(
                                        'Tapped upvote: ${item.permlink}',
                                      ),
                                  onTapComment:
                                      (item) => showSnackBar(
                                        'Tapped comment: ${item.permlink}',
