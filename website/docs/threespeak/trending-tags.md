...
-   [ThreeSpeakVideoFeed](/docs/video-feed-1) - Can be used in conjunction with `ThreeSpeakTrendingTags` to display videos for a selected tag using `feedType: ThreeSpeakVideoFeedType.trendingTagFeed`.
